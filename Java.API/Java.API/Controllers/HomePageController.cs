...
namespace Java.API.Controllers
{
    ...
    public class HomePageController : ApiController
    {
        ...
        public HomePageResponse GetHomePage()
        {
            ...
            string ViewImagePath = Convert.ToString(System.Configuration.ConfigurationManager.AppSettings["ViewImagePath"]);
            foreach (var evt in past)
            {
                past_events.Add(new Event()
                {
                    ...
                    image = ViewImagePath + "/EventBanners/" + evt.EventBanner,
                    SliderImage = ViewImagePath  + "/HomeBanners/" + evt.EventHomeBanner,
