...
namespace Admin.Controllers
{
    ...
    public class BlockSeatController : Controller
    {
        ...
        {
            ViewData["Events"] = db.tblEvents.Where(x => x.Status == "a").OrderBy(e=>e.EventID).ToList();
            return View();
        }
        ...
        private void UpdateConfigs()
        {
            ...
            {
                System.Threading.Tasks.Task.Run(() => SA.LA.ExceptionLogger.LogException("Artist Controller", "UpdateConfigs()", ex));
            }
        }
